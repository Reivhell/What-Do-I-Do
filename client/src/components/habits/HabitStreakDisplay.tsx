  ...
  return (
    <div className="flex items-center justify-between gap-4 bg-clay-surface-alt clay-inset rounded-[--radius-md] p-3">
      ...
      <div className="flex flex-col items-center gap-0.5">
        <span className="font-body text-[11px] clr-text-secondary uppercase tracking-wider">Streak</span>
      ...
      {/* Best streak */}
      <div className="flex flex-col items-center gap-0.5">
        <span className="font-body text-[11px] clr-text-secondary uppercase tracking-wider">Best</span>
        <span className="font-display text-lg font-semibold clr-text-primary">{best}</span>
        <span className="text-sm">🏆</span>
      </div>

      {/* Divider */}
      <div className="h-10 w-px bg-clr-divider-soft" />

      {/* Completion rate */}
      <div className="flex flex-col items-center gap-0.5">
        <span className="font-body text-[11px] clr-text-secondary uppercase tracking-wider">Rate</span>
        <span className={`font-display text-lg font-semibold ${
          rate >= 70 ? 'text-semantic-green' : rate >= 40 ? 'text-semantic-amber' : 'text-semantic-red'
        }`}>
          {rate}%
        </span>
        <span className="text-[11px] clr-text-secondary">{completionCount}/{total}</span>
      </div>
    </div>
  );
}
