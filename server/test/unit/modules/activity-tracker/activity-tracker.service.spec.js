...
const activity_tracker_service_1 = require("../../../../src/modules/activity-tracker/activity-tracker.service");
...
describe('ActivityTrackerService', () => {
    ...
    beforeAll(async () => {
        ...
        const module = await testing_1.Test.createTestingModule({
            providers: [
                activity_tracker_service_1.ActivityTrackerService,
        ...
        service = module.get(activity_tracker_service_1.ActivityTrackerService);
    ...
    describe('start', () => {
        it('should insert a new session and invalidate statistics', async () => {
            ...
            expect(db.insert).toHaveBeenCalledWith(drizzle_1.schema.activitySessions);
        ...
        it('should auto-stop existing active session before starting new one', async () => {
            ...
            expect(db.insert).toHaveBeenCalledWith(drizzle_1.schema.activitySessions); // start inserts new one
