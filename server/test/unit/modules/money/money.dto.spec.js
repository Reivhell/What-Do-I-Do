...
const money_dto_1 = require("../../../../src/modules/money/dto/money.dto");
describe('CreateAccountDto', () => {
    it('should allow property assignment', () => {
        const dto = new money_dto_1.CreateAccountDto();
...
describe('CreateTransactionDto', () => {
    it('should allow property assignment', () => {
        const dto = new money_dto_1.CreateTransactionDto();
...
describe('CreateRecurringBillDto', () => {
    it('should allow property assignment', () => {
        const dto = new money_dto_1.CreateRecurringBillDto();
        dto.name = 'Netflix';
        dto.amount = 15.99;
        dto.dueDay = 15;
...
describe('CreateBudgetDto', () => {
    it('should allow property assignment', () => {
        const dto = new money_dto_1.CreateBudgetDto();
